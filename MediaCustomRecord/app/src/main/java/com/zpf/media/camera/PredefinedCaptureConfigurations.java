...
//    public static final int WIDTH_360P      = 640;
    ...
    public static final int BITRATE_LQ_480P = 90000;
    public static final int BITRATE_MQ_480P = 90000;
    public static final int BITRATE_HQ_480P = 90000;
    public static final int HEIGHT_480P     = 480;
    public static final int WIDTH_480P      = 640;
    public static final int FPS_480P      = 20;
...
//    public static final int WIDTH_2160P      = 3840;
    ...
    public enum CaptureResolution {
        ...
        RES_480P(WIDTH_480P, HEIGHT_480P, BITRATE_HQ_480P, BITRATE_MQ_480P, BITRATE_LQ_480P,FPS_480P) ,;           // SD
...
//        RES_2160P(WIDTH_2160P, HEIGHT_2160P, BITRATE_HQ_2160P, BITRATE_MQ_2160P, BITRATE_LQ_2160P), ;    // 4K
        ...
        private CaptureResolution(int width, int height, int highBitrate, int medBitrate, int lowBitrate,int fps) {
            this.width = width;
            this.height = height;
