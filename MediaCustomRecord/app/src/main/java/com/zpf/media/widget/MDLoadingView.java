 ...
 * date:2019-08-16
 */
public class MDLoadingView extends View {
    ...
    public MDLoadingView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MDLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        TypedArray t = null;
        try {
            t = context.obtainStyledAttributes(attrs, R.styleable.MDLoadingView,
                    0, defStyleAttr);
            setbGradient(t.getBoolean(R.styleable.MDLoadingView_bGradient, true));
            circleColor = t.getColor(R.styleable.MDLoadingView_circleColor,
                    getResources().getColor(android.R.color.holo_blue_light));
            circleWidth = t.getDimensionPixelSize(R.styleable.MDLoadingView_circleWidth,
                    10);
            radius = t.getDimensionPixelSize(R.styleable.MDLoadingView_radius,
                    50);
        } finally {
            if (t != null) {
                t.recycle();
